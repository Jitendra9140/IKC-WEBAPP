...
router.get('/teacher/:teacherId/admin', auth, async (req, res) => {
  try {
...
router.get('/teacher/payment/:teacherId', auth, async (req, res) => {
  try {
    // Validate teacherId is a valid ObjectId
...
router.get('/teacher/:id/payments', async (req, res) => {
  try {
